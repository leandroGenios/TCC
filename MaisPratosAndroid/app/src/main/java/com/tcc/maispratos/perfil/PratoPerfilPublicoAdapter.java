...
import com.tcc.maispratos.prato.LinePratoHolder;
import com.tcc.maispratos.prato.Prato;

import java.util.List;

public class PratoPerfilPublicoAdapter extends RecyclerView.Adapter<LinePratoHolder> {
    private final List<Prato> pratos;
    private PerfilPublicoActivity activity;

    public PratoPerfilPublicoAdapter(List<Prato> pratos, PerfilPublicoActivity activity) {
